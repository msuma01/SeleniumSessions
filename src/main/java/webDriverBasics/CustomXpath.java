...
public class CustomXpath {
	...
	public static void main(String[] args) {
		...
		//Xpath: XML Path: HTML, XML Path: Address of the element in the DOM (Document Object Model)
		//DOM: HTML+ XML
	...
	//	Syntax of Xpath: //htmltag[@attr = 'value']
...
//				<input "id=firstname">
			...
			//	By mesg = By.xpath("//span[contains(text(),'your transaction id is')]");
				...
				//InvalidSelectorException: Cascaded/Compound class names not permitted
