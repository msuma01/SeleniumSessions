...
//		driver.findElement(By.id("jex")).sendKeys("This is my current crush name");
//		
//		driver.switchTo().frame("pact3");//f3
//		driver.findElement(By.id("glaf")).sendKeys("This is my destination");
//		
////		driver.switchTo().parentFrame();//f2
////		driver.findElement(By.id("jex")).sendKeys("  my destination");
////		
////		driver.switchTo().parentFrame();//f1
////		driver.findElement(By.id("inp_val")).sendKeys(" author");
//		
